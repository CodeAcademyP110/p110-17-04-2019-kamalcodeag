...
window.onload = function()
{
    ...
    const countries = [{id: 1, name: "Azerbaijan"}, 
                       {id: 2, name: "Turkey"}, 
                       {id: 3, name: "Russia"}, 
                       {id: 4, name: "Georgia"},
                       {id: 5, name: "Latvia"}];

    const cities =  [{name: "Baku", countryId: 1}, 
                    {name: "Sumgayit", countryId: 1}, 
                    {name: "Barda", countryId: 1}, 
                    {name: "Istanbul", countryId: 2}, 
                    {name: "Ankara", countryId: 2}, 
                    {name: "Moskva", countryId: 3}, 
                    {name: "Peterburq", countryId: 3}, 
                    {name: "Tbilisi", countryId: 4}, 
                    {name: "Batumi", countryId: 4}, 
                    {name: "Borjomi", countryId: 4}]; 
